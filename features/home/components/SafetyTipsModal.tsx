...
const TIPS = [
  ...
  {
    icon: KeyRound,
    text: "Never share your OTP, PIN, or password with anyone — not even someone claiming to be from Cosmopolitan.",
  },
  {
    icon: Flag,
        ...
        >
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-500">
              Cosmopolitan connects real people nearby — most of them are exactly who they say they are. A few habits keep it that way for everyone.
            </p>
